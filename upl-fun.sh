...
#########################
	...
	if [ "`lsb_release -d`" = "Description:	Ubuntu $UVER" ]; then
		echo "Ubuntu 21.04 wykryte."
	else
...
...za chwilę uruchomię je. Po uruchomieniu postępuj wg poniższych pkt.:\n\
 ...
 - kliknij przycisk \e[92m|Zastosuj dla całego systemu|\e[39m"
		...
		sudo pkgnome-language-selector
...
#dpkg-reconfigure locales
	...
	zenity --title="Instalator PDU" \
		...
		--width=745 \
		--height=800 \
		--icon="/usr/share/icons/Yaru/256x256/apps/system-software-install.png"
